    ...
    <div className={cn("flex items-center justify-center w-full py-12", className)}>
      <motion.div
        ...
        className={cn(
          ...
          "border bg-neutral-900/70 border-neutral-800 backdrop-blur-2xl shadow-lg"
        )}
        style={{
                  ...
                  >
                    <Button
                      ...
                      className={cn(
                        ...
                        "transition-colors",
                        isHovered && "shadow-lg shadow-pink-500/20"
                      )}
                      onClick={() => {
                    ...
                    >
                      ...
                      {isHovered && (
                        <motion.span
                          layoutId="glow"
                          className="absolute inset-0 rounded-2xl border border-pink-500/40"
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
                          exit={{ opacity: 0 }}
                        />
                    ...
                    {isActive && (
                      <motion.div
                        layoutId="dot"
                        className="w-1.5 h-1.5 rounded-full bg-pink-500 mt-1"
                      />
                    )}
                  </motion.div>
                </TooltipTrigger>
